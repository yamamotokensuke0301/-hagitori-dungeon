(function () {
  ...
  const advices = Object.freeze([
    "モンスターは倒し方で剥ぎ取れる素材が変わる。覚えとくといい。",
    "ユニークモンスターの遺体は通常より多く剥ぎ取れる。",
    "罠を見つけるのはむつかしい。しかし、見つけた罠は器用さと運次第で解除しやすくなる。",
    "十階層ごとの守護者を倒せば、その階層へ街から直接向かえるようになる。",
    "宝箱の魔法書は魔法職なら自宅で読める。売るか読むかはよく考えろ。",
    "アーティファクトは商店では売れない。装備から外してギルドへ納めるんだ。ギルドポイントはいいぞ。",
    "加速度が10増えるたび、世界が一度動く間の行動回数が増える。",
    "よぉし！　いい感じだあ",
    "召喚を使うユニークは配下が増える前に本体を崩すか、通路で数を絞るといい。",
    "賞金首の遺体を持ち帰ってギルドに行けば、報酬を受け取ることができる。",
    ...
    "危険度の高い罠ほど解除しにくい。",
    "罠は三度作動すると壊れる。耐えて踏み潰す手もあるが。",
    "罠の解除は器用さと運だけではない。性格や種族、職業の手先の違いも結果へ出る。",
    "いらないやつはいらない。",
    "この上なくいい展開の時ほど死にやすい",
    "酒は飲めるのか？",
    "帰還はいつでもできるが、かといって甘くみてると命取りだ。",
    "狂気の部屋を見つけても、全員を同時に起こす必要はない。入口を使って少しずつ崩せ。",
    "宝物庫の箱は値打ち物が多い。持ち帰れなければ価値はゼロだ、欲張りすぎるなよ。",
    "スリル部屋の星箱は守護者を倒すまで開かない。",
    "世の中には固定アーティファクトとそうではないアーティファクトがあるらしい",
    "呪われた星装備も、呪耐性を重ねれば代価を小さくできる。",
    ...
    "ユニークモンスターは一度倒すと、その冒険者の前には二度と現れない。",
    "このゲームのクリア率はとてつもなく低い",
    "耐性は重要だ。甘く見てると死ぬぞ。",
    "噂によると地下１００階より下があるらしい。",
    "加速度は最重要だ。加速度が速いほど速く動ける。",
    "近接職は初心者向けらしい。",
    "再生装備は探索で有利になる。闘技場でも有効だ。",
    "自爆する魔物の遺体からは剥ぎ取れない。爆ぜる前に倒す価値は、経験値だけではない。",
    "金を盗む魔物に奪われた金は、倒しても戻らない。接近される前に仕留めろ。",
    "魔法書は同じ術を覚えた後でも売れる。読み終えた系統の本は旅費へ替えるといい。",
    "とんでもないものが浅い階にでることもある。",
    "敵に隣接さえされてなければ、いつでも帰還できる。",
    "死ねばほとんど全部やり直しになるが、何もかもが０になる訳ではない。",
    "調査記録をよく見ろ。",
  ]);
